...
amazon_patio_train = 'data/amazon/training_data_patio';
amazon_patio_test = 'data/amazon/test_data_patio'; 

amazon_music_train = 'data/amazon/training_data_music';
amazon_music_test = 'data/amazon/test_data_music'; 

amazon_instruments_train = 'data/amazon/training_data_instruments';
amazon_instruments_test = 'data/amazon/test_data_instruments';  

amazon_baby_train = 'data/amazon/training_data_baby';
amazon_baby_test = 'data/amazon/test_data_baby';  
...
% Covtype-back
covtype_train_back = 'data/covtype-back/train_data';
covtype_test_back = 'data/covtype-back/test_data';
...
% training_data = amazon_baby_train;
% test_data = amazon_baby_test;
% 
% training_data = amazon_music_train;
% test_data = amazon_music_test;

% training_data = amazon_patio_train;
% test_data = amazon_patio_test;
...
% training_data = covtype_train_back;
% test_data = covtype_test_back;
